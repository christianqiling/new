...
const routes = {
  ...
  'GET /api/my-cards': api.myCards,
  'POST /api/cards/delete': api.cardDeleteSelf,
  'POST /api/cards/add': api.cardAddSelf,
  'GET /api/recharge-code': api.rechargeCode,
  ...
  'GET /api/admin/users/export': api.usersExport,
  ...
  'POST /api/admin/cards/add': api.adminCardAdd,
  'POST /api/admin/cards/delete': api.adminCardDelete,
  'POST /api/admin/level2-password': api.level2PasswordSet,
  'POST /api/admin/my-admin-password': api.myAdminPasswordSet,
  'POST /api/admin/reset-admin-password': api.resetAdminPassword,
  'GET /api/admin/super-auth-code': api.superAuthCode,
  'GET /api/announcements': api.announcementsList,
  'POST /api/admin/announcements': api.announceCreate,
  'POST /api/admin/announcements/delete': api.announceDelete,
  'POST /api/admin/announcements/pin': api.announcePin,
